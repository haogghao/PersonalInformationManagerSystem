...
<script
	...
	<script
	src="${pageContext.request.contextPath}/bootstrap/js/clear.js"></script>
<script type="text/javascript">
         function loadImage(){
...
<body>
	<div>
		<form id="biaodan" class="form-signin" action="login" method="post"
			...
			<table>
				...
				<tr>
					<td></td>
					<td ><Button type="submit" class="btn btn-primary">登录</Button>&nbsp;&nbsp;
						<Button  type="reset"  onclick="clear();"  class="btn btn-primary">重置</Button>
					</td>
					<td></td>
				</tr>
				<tr><td></td>
				<td>若还没注册请<a href="register.jsp">注册</a></td></tr>
			</table>
		</form>
		<form>
